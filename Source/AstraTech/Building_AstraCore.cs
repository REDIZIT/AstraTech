...
namespace AstraTech
{
    public class Building_AstraCore : Building
    {
        ...
        public override string GetInspectString()
        {
            ...
            b.AppendLine();
            b.Append("Metal matter: ");
            b.Append((int)silverMatter);

            b.AppendLine();
            b.Append("Organic matter: ");
            b.Append((organicMatterInTicks / (float)GenDate.TicksPerDay).ToString("F0"));
